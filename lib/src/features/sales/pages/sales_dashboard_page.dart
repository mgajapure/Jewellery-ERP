...
class SalesDashboardPage extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> _metrics = const [
    {'labelMr': 'आजची विक्री', 'labelEn': "Today's Sales", 'value': '12', 'color': 0xFF061C49},
    {'labelMr': 'आजचे उत्पन्न', 'labelEn': "Today's Revenue", 'value': '₹ 3.8L', 'color': 0xFFE7A726},
    {'labelMr': 'मासिक उत्पन्न', 'labelEn': 'Monthly Revenue', 'value': '₹ 28.5L', 'color': 0xFF07934A},
    {'labelMr': 'सरासरी इन्व्हॉईस', 'labelEn': 'Avg Invoice', 'value': '₹ 31,750', 'color': 0xFF2563EB},
    {'labelMr': 'टॉप श्रेणी', 'labelEn': 'Top Category', 'value': 'Gold Chain', 'color': 0xFF061C49},
    {'labelMr': 'प्रलंबित परतावा', 'labelEn': 'Pending Returns', 'value': '2', 'color': 0xFFF59E0B},
  ];
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const Icon(Icons.chevron_right, color: SalesColors.navy),
          ],
        ),
      ),
    );
